...
class OptionJumpers(object):
	...
	def setOptions(self):
		'''Set values of the current **optionsDict**.'''
		#Baseball
		...
		#Multisport
		if self.sport=='MPMULTISPORT1-baseball' or self.sport=='MPLX3450-baseball' or self.sport=='MPMULTISPORT1-football' or self.sport=='MPLX3450-football':
			if self.jumperString[0]=='B':
